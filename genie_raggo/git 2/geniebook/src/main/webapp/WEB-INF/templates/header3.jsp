				...
				<div class="col-sm-4">
					<div class="logo pull-left">
						<a href="<c:url value="/"/>"><img width="400" height=""
							src="<c:url value="/resources/images/home/logo_logo.png"/>"
							alt="" /></a>
					</div>
				</div>
				<div class="col-sm-8">
							...
							<c:if test="${pageContext.request.userPrincipal.name != null}">
								<c:if
									...
									<li class="nav-item"><a class="nav-link"
										href="<c:url value="/admin/adminManager"/> "><i class="fa fa-gears"></i>관리자기능</a></li>
								</c:if>
								...
								<li class="nav-item"><a class="nav-link"
									href="javascript:document.getElementById('logout').submit()"><i class="fa fa-unlock"></i>로그아웃</a>
								</li>
				...
				<div class="col-sm-9">
					...
					<div class="mainmenu pull-left">
						<ul class="nav navbar-nav collapse navbar-collapse">
							...
							<li class="dropdown"><a href="<c:url value="/event"/>"><i class="fa fa-gift"></i>Event</a>	
							<c:if
									test="${pageContext.request.userPrincipal.name == 'admin'}">
									<li class="dropdown"><a
								href="<c:url value="/admin/adminManager"/>"><i class="fa fa-group"></i>회원관리<!-- <i class="fa fa-angle-down"></i> --></a>
								</c:if>
					...
					<div class="carousel-inner">
						<div class="item active">
							<div class="col-sm-6">
								...
								<h2>루이자 메이 알코트</h2>
								<p>
									성격도 생김새도 완전히 다른 네 자매, 메그, 조, 베스, 에이미. <br>소설 역사상 가장 사랑받은
									자매들의 이야기를 968쪽의 디럭스 양장본으로 만나보세요!
								</p>
						...
						<div class="item">
							<div class="col-sm-6">
								...
								<h2>윤동주</h2>
								<p>
									한국인이 사랑하는 시인 1위, 독립운동가 3위에 랭크된 시인,<br>하늘과 바람과 별을 노래한 서정시와
									저항과 성찰의 민족시인.<br>윤동주 탄생 100주년 기념 윤동주 전체 작품 124편을 다 담았습니다.
								</p>
								<button type="button" class="btn btn-default get">Get
									it now</button>
							</div>
						...
						<div class="item">
							<div class="col-sm-6">
								...
								<h2>이기주</h2>
								<p>
									말과 사람과 품격에 대한 이야기.<br>《언어의 온도》로 많은 독자의 공감을 얻은 이기주 작가의 새로운
									에세이집을 만나보세요!
								</p>
								<button type="button" class="btn btn-default get">Get
									it now</button>
