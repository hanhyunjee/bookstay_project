...
<script type="text/javascript">
	...
	function fn_prev(page, range, rangeSize) {
		...
		var url = "${pageContext.request.contextPath}/notice/listnotices";
	...
	<div class="container">
		<div class="product-details">
			...
			<div class="view-product">
				<table class="table" border="0"
					...
					<c:forEach var="row" items="${noticelist}">
						<tr>
							...
							<td>${row.adminId}</td>
							<td><a
								href="${contextPath }/notice/viewNotice?noticeId=${row.noticeId}">${row.title}</a></td>
				...
				<c:if test="${id eq 'admin' }">		<!-- admin으로 변경 -->
					<input type=button value="공지사항 글쓰기" onClick="noticeForm()"
