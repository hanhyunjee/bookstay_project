...
<%-- <th><br> <input type="hidden"
	...
	<h1 style="text-align: center">커뮤니티 작성</h1>
	<div class="container">
		<form name="commonForm" method="post"
			action="${contextPath}/common/addCommon?${_csrf.parameterName}=${_csrf.token}" enctype="multipart/form-data">
			<!-- " -->
