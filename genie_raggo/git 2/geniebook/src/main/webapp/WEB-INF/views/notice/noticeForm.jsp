...
<script type="text/javascript">
	...
	function backToList(obj) {
		obj.action = "${contextPath}/notice/listnotices?${_csrf.parameterName}=${_csrf.token}";
		obj.submit();
	}
...
<%-- <th><br> <input type="hidden"
	...
	<div class="container">
		<form name="noticeForm" method="post"
			action="${contextPath}/notice/addNotice?${_csrf.parameterName}=${_csrf.token}" enctype="multipart/form-data">
			<!-- " -->
			<table class="table" border="0" align="center">
				<tr>
					<td align="right">작성자</td>
					<td colspan=2 align="left"><label>${adminId}</label>
					<input type="hidden" name="adminId" value="${adminId}">
					</td>
				</tr>
				<tr>
					<td align="right">공지사항 글제목</td>
					<td colspan="2"><input type="text" size="67" maxlength="500"
						name="title" placeholder="제목을 입력해주세요." /></td>
				</tr>
				<tr>
					<td align="right" valign="top"><br>공지사항 글내용</td>
