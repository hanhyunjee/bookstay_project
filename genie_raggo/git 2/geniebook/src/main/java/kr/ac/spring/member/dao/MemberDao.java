...
public class MemberDao {
	...
	public int selectPoint(String id) {
		int point = sqlSession.selectOne("mapper.member.selectPointById",id);
			return point;
		
	}
	
	public void deductPoint(int point, String id) {
		Map<String,Object>map = new HashMap<String, Object>();
		map.put("id", id);
		map.put("point", point);
		sqlSession.update("mapper.member.deductPoint",map);
	}
