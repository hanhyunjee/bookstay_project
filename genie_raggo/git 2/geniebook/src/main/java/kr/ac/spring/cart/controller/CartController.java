...
public class CartController {
	...
	public String getCart(Model model) throws Exception {
		...
		int point = memberService.selectPoint(id);						// 포인트 조회
	...
	@RequestMapping(value = "/checkout/{id}/{cartId}/{point}" , method =  RequestMethod.GET)  // 상품 구매 
	public String CheckOut(@PathVariable("cartId") int cartId, @PathVariable("id") String id, @PathVariable("point") int point, Model model) throws Exception {  // Restful 형식의 url에서 파라미터를 가져오기 위한 @PathVariable 어노테이션
